...
"Accept" =>"application/vnd.github.squirrel-girl-preview+json"))
                ...
                site.data['issues'][i] << tmp #tmp #also crashes. probbaly due to teh i index. doe sit crash when existing? yes. now trying to set ne wobject altogether
                puts "survived"
                p "reactions="
