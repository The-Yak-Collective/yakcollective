...
<small class="f6 db tc mt3 w-75 w-100-l center"><a href="{{site.members[which_one].url}}" class="dib tl" id="featured_yak">{{ which_one }} __and__ {% include member-card-include member=the_one %} </a></small>
<script>
