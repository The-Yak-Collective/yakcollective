...
You can learn more about the Yak Collective on our [about page](../about.md). If it’s been a while since you last checked in, be aware that our mission has evolved quite significantly since we started out nearly two years ago. If you haven’t already, you can get on our Discord server via the form on the [join page](../join.md).
