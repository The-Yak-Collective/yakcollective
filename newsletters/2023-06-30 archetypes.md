...
---
We encountered many types of characters in our Season 2 readings, often embodying recurring tropes. Regular attendees used a lightweight group process to sort these character types into a handful of archetypes. The archetypes — *benevolent dictator*, *backstopper*, *shapeshifter*, and *anarch* — can be found in two modes, Mature (–), an underdeveloped or corrupt version of the archetype, and Mature (+), a thriving, purposefully actualizing version.
...
*Mature (+): Esteemed steward.* Provides sufficient structure and kindling to keep a group focused and supplied with ideas. Promote a balance of staying aligned and pushing boundaries. Sparingly intervenes to help the project KTLO when necessary. Due to the public nature of their post as BD, their efforts here are more legible than that of the *backstopper* (see next).
